...
try {
	...
	$response = $api->assignUserToResource($resourceId, $userId);
	echo print_r($response, true) . "<br/>";

	echo "<br/>UNASSIGNING USER WITH ID = " . $userId
	. " FROM RESOURCE WITH ID = " . $resourceId . "<br/>";
	// unassigns user from resource
	$response = $api->unassignUserFromResource($resourceId, $userId);
	echo print_r($response, true) . "<br/>";
	...
	$response = $api->assignTokenToResource($resourceId, $tokenId);
	echo print_r($response, true) . "<br/>";

	echo "<br/>UNASSIGNING TOKEN WITH ID = " . $tokenId
	. " FROM RESOURCE WITH ID = " . $resourceId . "<br/>";
	// unassigns token from resource
	$response = $api->unassignTokenFromResource($resourceId, $tokenId);
	echo print_r($response, true) . "<br/>";
	...
	$response = $api->assignUserAndTokenToResource($resourceId, $userId, $tokenId);
	echo print_r($response, true) . "<br/>";
	...
	$response = $api->unassignUserAndTokenFromResource($resourceId, $userId, $tokenId);
	echo print_r($response, true) . "<br/>";
